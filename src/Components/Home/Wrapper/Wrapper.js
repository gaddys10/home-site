            ...
            <div className= "home-wrapper">
                ...
                <div className="cvBody">
                    ...
                    <ul className="jobBody">
                        ...
                        <li className= "jobDesc"> Created ReactJS project from ground-up as sole developer to provide a single login portal for all desktop-based consumer software, including recently acquired software containing their own login systems </li>
